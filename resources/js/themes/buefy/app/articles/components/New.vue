    ...
    <div class="columns">
      ...
      <div class="column is-10">
        <div class="box m-t-50">
          <b-tabs type="is-toggled" v-if="categories">
            <b-tab-item label="Article" icon="pen">
              <form action="#" method="post" enctype="multipart/form-data">
                ...
                <section>
                  ...
                  <b-field
                    v-bind:message="errors.category_id"
                    v-bind:type="errors.category_id ? 'is-danger' : ''"
                    :label-position="labelPosition"
                    label="Under Category"
                  >
                    <b-select v-model="category_id" placeholder="Choose Category">
                      <option
          ...
          <template v-if="categories < 1">
            <p>
              ...
              <router-link to="/admin/categories/new">category first.</router-link>
            </p>
          </template>
        </div>
      </div>
